        ...
        function doModel()
        {
            switch( $this->action ) {
                ...
                case('register_post'):  //register user
                                        ...
                                        switch($success) {
                                            case 1: osc_add_flash_ok_message( _m('The user has been created. An activation email has been sent. If you do not receive the confirmation 
											email within a few minutes, please check your Junk E-mail folder just in case the confirmation email 
