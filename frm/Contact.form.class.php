<?php if ( ! defined('ABS_PATH')) exit('ABS_PATH is not loaded. Direct access is not allowed.');
    ...
    class ContactForm extends Form {
		...
		static public function what_apps() {
            if( Session::newInstance()->_getForm("what_apps") != "" ) {
                $subject = Session::newInstance()->_getForm("what_apps");
                parent::generic_input_checkbox("what_apps", $subject, null, false);
            } else {
                parent::generic_input_checkbox("what_apps", "Yes you can contact me through WhatApps", '1', false);
            }
            return true;
        }
