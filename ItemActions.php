    ...
    Class ItemActions
    {
        ...
        public function add()
        {
            ...
            $flash_error .=
                ...
                ((!osc_validate_max($contactName, 50)) ? _m("Name too long.") . PHP_EOL : '' ) .
                ...
                ((!osc_validate_max($aItem['address'], 200)) ? _m("Address too long.") . PHP_EOL : '' ) .
			...
			$flash_error .=
                ...
                ((!osc_validate_max($aItem['contactPhone'], 100)) ? _m("Phone Number too long.") . PHP_EOL : '' );
			...
			if(osc_recaptcha_items_enabled() && osc_recaptcha_private_key() != '') {
					if(!osc_check_recaptcha()) {
						...
						return 3; // BREAK THE PROCESS, THE RECAPTCHA IS WRONG
					}
				}
        ...
        function edit() {
            ...
            if ($flash_error) {
                ...
                if($aItem['userId'] != '') {
					...
					$aItem['contactEmail'] = $aItem['contactEmail'];
					$aItem['contactPhone'] = $aItem['contactPhone'];
                } else {
                    $aItem['userId']      = NULL;
                }
        ...
        private function prepareDataForFunction( $action )
        {
            ...
            switch ( $action ){
                ...
                case 'contact':
					...
					$aItem['what_apps']     = Params::getParam('what_apps');
                break;
                case 'add_comment':
                    $item = $this->manager->findByPrimaryKey( Params::getParam('id') );
